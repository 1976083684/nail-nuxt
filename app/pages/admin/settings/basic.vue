      ...
      >
        <div class="flex items-start gap-4">
          <div class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center shrink-0">
            <i :class="getIcon(item.setting_key)" class="text-pink-500" />
          </div>
          <div class="flex-1">
            ...
            <input
              ...
              class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:border-pink-400 focus:ring-1 focus:ring-pink-400 outline-none transition-colors"
            />
          </div>
        </div>
      </div>
